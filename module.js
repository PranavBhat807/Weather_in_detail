 ...
 * @returns {string} kilometer per hour
 */
...
export const aqiText = {
    ...
    2: {
        level: "Fair",
        message: "Air quality is acceptable; however for some pollutants there may be a moderate health concern for a very small number of people who are unusually sensitive to pollution"
    },
    3: {
        level: "Moderate",
